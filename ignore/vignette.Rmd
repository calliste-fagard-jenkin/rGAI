...
missing covaraite values. Because of this, any NA covariate values in data.frame
...
# Trying to fit a covaraite model with these new data will throw the relevant
# errors:
...
lines(c(1, 8), rep(plot.base, 2), col = plot.col)
