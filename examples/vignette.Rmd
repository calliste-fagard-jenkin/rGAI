...
# If you have already downloaded the package from github:
install("GAI")

# Alternatively, if you would like R to download the package directly from 
# github automatically, use the below line of code to install the package
# instead:
